...
% Υπολογισμό φίλτρων για Ν = 8,16, 32 και 64 συντελεστές
w1 = kaiser(N1)'; h1 = hd1.*w1; H1 = freqz(h1,1,w); % N = 8
w2 = kaiser(N2)'; h2 = hd2.*w2; H2 = freqz(h2,1,w); % N = 16
w3 = kaiser(N3)'; h3 = hd3.*w3; H3 = freqz(h3,1,w); % N = 32
w4 = kaiser(N4)'; h4 = hd4.*w4; H4 = freqz(h4,1,w); % N = 64
