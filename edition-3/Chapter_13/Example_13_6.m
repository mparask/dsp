...
w1s=0.2*pi; w1p=0.25*pi; w2p=0.7*pi; w2s=0.75*pi % Συχνότητες αποκοπής στο διάστημα [0,π]
f1s = w1s*Fs/(2*pi);  % Συχνότητα αποκοπής ζώνης αποκοπής στο διάστημα [0,Fs/2]
f1p = w1p*Fs/(2*pi);  % Συχνότητα αποκοπής ζώνης διέλευσης στο διάστημα [0,Fs/2]
f2p = w2p*Fs/(2*pi);  % Συχνότητα αποκοπής ζώνης διέλευσης στο διάστημα [0,Fs/2]
f2s = w2s*Fs/(2*pi);  % Συχνότητα αποκοπής ζώνης αποκοπής στο διάστημα [0,Fs/2]
Rp = 1.0;   % Κυμάτωση στη ζώνη διέλευσης (dB)
...
% Υπολογισμός κρουστικής απόκρισης με ParksMcClellan
